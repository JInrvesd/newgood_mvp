...
## 군 복무 경력 제외 (중요)
- 군 복무(육군, 해군, 공군, 해병대, 사회복무요원 등)는 experience 배열에 포함하지 않습니다.
- 군 복무 관련 내용이 있더라도 경력(experience)이 아닌 별도 항목으로 취급하여 무시합니다.
- 예: "육군 병장 만기전역", "사회복무요원 근무" 등은 experience에 넣지 마세요.

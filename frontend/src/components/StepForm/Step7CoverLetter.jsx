  ...
  const structuredFields = [
    {
      key: 'growth',
      label: '성장과정',
      placeholder: '성장 배경과 가치관 형성에 영향을 준 경험을 작성해 주세요.',
      maxLength: 2000,
    },
    {
      key: 'personality',
      label: '성격 / 장단점',
      placeholder: '본인의 성격적 강점과 약점, 이를 극복하기 위한 노력을 작성해 주세요.',
      maxLength: 2000,
    },
    {
      key: 'motivation',
      label: '지원동기',
      placeholder: '해당 직무/회사에 지원하게 된 동기와 본인이 적합한 이유를 작성해 주세요.',
      maxLength: 2000,
    },
    {
      key: 'aspiration',
      label: '입사 후 포부',
      placeholder: '입사 후 달성하고 싶은 목표와 기여 방안을 작성해 주세요.',
      maxLength: 2000,
    },
  ]
